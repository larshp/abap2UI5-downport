...
CLASS z2ui5_lcl_fw_app IMPLEMENTATION.
  ...
  METHOD factory_error.
    ...
    DATA temp26 TYPE REF TO z2ui5_if_app.
    temp26 ?= app.
    result->ms_error-app     = temp26.
  ENDMETHOD.
...
CLASS z2ui5_lcl_fw_handler IMPLEMENTATION.
  ...
  METHOD request_end.
    ...
    DATA temp27 TYPE z2ui5_if_client=>ty_s_next-_viewmodel.
    IF ms_next-s_set-_viewmodel IS NOT INITIAL.
      temp27 = ms_next-s_set-_viewmodel.
    ELSE.
      temp27 = bind_back_2_front( lo_app = ms_db-o_app t_attri = ms_db-t_attri ).
    ENDIF.
    DATA lv_viewmodel LIKE temp27.
    lv_viewmodel = temp27.
  ...
  METHOD bind_front_2_back.
    DATA temp12 LIKE LINE OF t_attri.
  ...
  METHOD bind_back_2_front.
    ...
    DATA r_view_model TYPE REF TO z2ui5_lcl_utility_tree_json.
    ...
    DATA temp11 LIKE LINE OF t_attri.
    ...
    LOOP AT t_attri REFERENCE INTO lr_attri WHERE bind_type <> ``.
      ...
      DATA temp12 TYPE REF TO z2ui5_lcl_utility_tree_json.
      IF lr_attri->bind_type = cs_bind_type-one_way.
        temp12 = r_view_model.
      ELSE.
        temp12 = lo_update.
      ENDIF.
      DATA lo_actual LIKE temp12.
      lo_actual = temp12.
  ...
  METHOD set_app_client.
    ...
    lo_arg = mo_body->get_attribute( `ARGUMENTS` ).
    TRY.
    ...
    TRY.
        DO.
          ...
          lv_val = lo_arg->get_attribute( temp28 )->get_val( ).
  ...
  METHOD _create_binding.
    ...
    DATA temp14 TYPE REF TO object.
    temp14 ?= ms_db-o_app.
    ...
    IF type = cs_bind_type-one_time.
      ...
      DATA temp15 TYPE z2ui5_lcl_utility=>ty_attri.
      CLEAR temp15.
      temp15-name = lv_id.
      temp15-data_stringify = z2ui5_lcl_utility=>trans_any_2_json( value ).
      temp15-bind_type = type.
      INSERT temp15
    ...
    DATA temp16 LIKE LINE OF ms_db-t_attri.
    ...
    temp20-bind_type = cs_bind_type-one_time.
    INSERT temp20
           INTO TABLE ms_db-t_attri.
    result = |/{ lv_id }|.
  ENDMETHOD.
...
CLASS z2ui5_lcl_fw_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~nav_app_home.
    DATA temp29 TYPE REF TO z2ui5_lcl_fw_app.
    CREATE OBJECT temp29 TYPE z2ui5_lcl_fw_app.
    z2ui5_if_client~nav_app_call( temp29 ).
  ENDMETHOD.

  METHOD z2ui5_if_client~get.
    DATA temp30 TYPE z2ui5_if_client=>ty_s_get.
    CLEAR temp30.
    MOVE-CORRESPONDING mo_handler->ms_db TO temp30.
    temp30-event = mo_handler->ms_actual-event.
    temp30-check_launchpad_active = mo_handler->ms_actual-check_launchpad_active.
    temp30-t_event_arg = mo_handler->ms_actual-t_event_arg.
    temp30-t_scroll_pos = mo_handler->ms_actual-t_scroll_pos.
    result = temp30.
  ENDMETHOD.
  ...
  METHOD z2ui5_if_client~_event.
    ...
    DATA temp31 LIKE LINE OF t_arg.
    DATA lr_arg LIKE REF TO temp31.
  ...
  METHOD z2ui5_if_client~get_app.
    ...
    temp32 ?= z2ui5_lcl_fw_db=>load_app( id )-o_app.
    result = temp32.
  ENDMETHOD.
ENDCLASS.
